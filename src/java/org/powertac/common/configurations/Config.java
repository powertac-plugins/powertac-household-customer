...
/**
 * The configuration class creates an instance that is capable of reading the configuration file
 * of our household models, which contains the variables needed to create realistic and autonomous
 * models of persons and appliances
 * 
...
public class Config {
  ...
  /** the scanner variable user to read the configuration file line by line **/
	...
	/** the hashmap variable that contains the variables and their values as read from configuration file **/
	HashMap variablesHashMap = new HashMap();

	
	/**
   * Function that allows read the configuration file by finding the variables contained inside
   * one by one and creating pairs of keys and values for the data to be stored
   */
	public void readConf() throws FileNotFoundException{
		
	  // Reading the configuration file
	  fileScanner = new Scanner(new File("../powertac-household-customer/config.txt"));
	...
	/**
   * The parsing function. It searches for the variable named after the string we import and creates
   * the pair of values for the HashMap.
   */
	...
	/**
   * Function that returns in string form the contents of the HashMap variable by means of
   * key and value.
   */
